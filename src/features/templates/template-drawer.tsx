  ...
  return (
    ...
    >
      ...
      >
        ...
        {message && (
          <p
            className="border-b border-slate-100 bg-indigo-50 px-5 py-2 text-xs font-medium text-indigo-700"
            role="status"
          >
            {message}
          </p>
        ...
        <div className="min-h-0 flex-1 overflow-y-auto p-4">
          ...
          <div className="space-y-2">
            {templates.data?.map((template) => (
              <article
                key={template.id}
                className="group rounded-xl border border-slate-200 p-3 transition hover:border-indigo-200 hover:shadow-sm"
              >

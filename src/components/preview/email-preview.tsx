...
export function EmailPreview() {
  ...
  return (
    <div className="min-h-full p-5 sm:p-8">
      <div
        className={cn(
          "mx-auto overflow-hidden rounded-[18px] border border-slate-300 bg-white shadow-[0_30px_90px_-30px_rgba(15,23,42,.4)] transition-[width] duration-300",
          previewMode === "mobile"
            ? "w-[390px] max-w-full"
            : "w-[860px] max-w-full",
      ...
      >
        <div className="flex h-11 items-center gap-3 border-b border-slate-200 bg-slate-50 px-4 text-slate-500">
          <div className="flex gap-1.5" aria-hidden="true">
            <span className="size-2.5 rounded-full bg-rose-400" />
            <span className="size-2.5 rounded-full bg-amber-400" />
            <span className="size-2.5 rounded-full bg-emerald-400" />
          </div>
          <div className="mx-auto flex h-7 max-w-sm min-w-0 flex-1 items-center justify-center gap-1.5 rounded-md border border-slate-200 bg-white px-3 text-[10px] font-medium">
